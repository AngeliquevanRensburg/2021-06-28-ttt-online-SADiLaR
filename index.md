...
instructor: ["Juan Steyn", "Angelique Trusler", "Caroline Fadeke Ajilogba"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
This is an online event. We will meet using the online videoconference software Zoom. You will need to <a href="https://zoom.us/download">download and install their client</a> to connect with your instructors. The link to use for this event is <{{ loc.address }}>. Use this code 202020. 
...
<p>
  Please see <a href="https://docs.google.com/document/d/1vWO9iZ2nugVk_BDqdRZTsSR5gFYuE3a1m-8AUKggfDc/edit">this document</a> for course material and schedule.
</p>
